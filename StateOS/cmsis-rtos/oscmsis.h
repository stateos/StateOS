...
/// Kernel Information
#define osVersionAPI         20010000   ///< API version (2.1.0)
#define osVersionKernel      40050000   ///< Kernel version (4.5.0)
#define osKernelId      "StateOS v4.5"  ///< Kernel identification string
